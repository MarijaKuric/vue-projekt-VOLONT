<template>
  ...
  >
    ...
    <div v-else class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mb-6 text-center">
      <p :class="darkMode ? 'text-white' : 'text-black'">Molimo odaberite događaj za koji želite dodati ili urediti zadatke.</p>
      <p :class="darkMode ? 'text-gray-300' : 'text-gray-600'" class="text-sm mt-2">Možete odabrati događaj iz pregleda.</p>
      <button
        @click="router.push('/organizator/pregled')"
    ...
    >
      <h3 class="text-lg font-bold mb-4" :class="darkMode ? 'text-white' : 'text-gray-700'">
